...
## This code is based on the tar_render function from [tarchetypes](https://github.com/ropensci/tarchetypes/tree/main)
...
tar_render_book <- function(name,
  ...
  targets::tar_target_raw(
    name = name,
    command = tar_render_book_command(path, args),
    packages = packages,
    library = library,
    format = "file",
    error = error,
